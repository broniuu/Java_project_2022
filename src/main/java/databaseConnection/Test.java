...
public class Test {
    public static void main(String[] args) {
        ...
        User user1 = new User("xD", "haha", "Filip",
                "Broniek", "Różana 20", "1234567890",
                "12/25", "111","aaaaa@bbb.com");
        //boolean delSuccess = userJdbcHelper.deleteUser(user1);
        boolean AddSuccess = userJdbcHelper.addUser(user);
        boolean AddSuccess1 = userJdbcHelper.addUser(user1);
        //boolean UpdateSuccess = userJdbcHelper.updateUser(user1);
